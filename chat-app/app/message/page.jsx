...
export default function page() {
  ...
  return (
    <div className="h-[92vh] w-full bg-[#F5F7FA] border rounded-xl shadow-md mx-auto max-w-5xl mt-4 flex flex-col">
      <div className="w-full px-5 py-4 border-b bg-white flex justify-between items-center">
        <div>
          <h2 className="font-semibold text-[18px]">Brother Limon</h2>
        ...
        <div className="flex items-center gap-5 relative">
          ...
          {openMenu && (
            <div
              ref={menuRef}
              className="absolute top-8 right-0 bg-white shadow-xl rounded-md w-[180px] py-2 border"
            >
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 flex flex-col gap-3">
        {messages.map(msg => (
          ...
          >
            <div
              className={`max-w-[60%] px-4 py-2 rounded-xl text-sm flex items-center gap-2 ${
                msg.sender === 'me'
      ...
      <div className="w-full px-4 py-3 border-t bg-white flex items-center gap-3">
