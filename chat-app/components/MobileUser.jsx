...
const MobileUser = () => {
  return (
    <>
      <section
        className={`mobile:w-full tablet:w-full laptop:w-full computer:w-0 h-auto  bg-transparent border border-white p-5 rounded-lg mobile:absolute mobile:top-[175px] mobile:left-0 tablet:absolute tablet:top-[185px] tablet:left-0 laptop:absolute laptop:top-[185px] laptop:left-0 computer:hidden`}
      >
