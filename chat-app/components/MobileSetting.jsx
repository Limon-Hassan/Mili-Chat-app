...
const MobileSetting = () => {
  ...
  return (
    <>
      <section className="mobile:w-full tablet:w-full laptop:w-full p-2 bg-gray-400/30 rounded-lg border border-gray-300 mobile:absolute mobile:top-[110px] mobile:left-0 tablet:absolute tablet:top-[110px] tablet:left-0 laptop:absolute laptop:top-[110px] laptop:left-0 ">
        ...
        <div className="mobile:mt-6 tablet:mt-10 laptop:mt-10 flex flex-col mx-auto gap-5 p-2 overflow-y-auto mobile:h-[55vh] tablet:h-[54vh] laptop:h-[75vh] ">
          <div className="relative">
            ...
            <span
              ...
              className="absolute bottom-0 left-0 w-[50px] h-[50px] bg-purple-600 flex items-center justify-center rounded-full cursor-pointer border border-gray-500"
            >
              <Plus />
            </span>
          </div>
          <div className="flex flex-col items-center justify-between border-b border-gray-400 pb-5 mobile:mt-5 tablet:mt-0 laptop:mt-0">
            <div className="relative mb-3.5">
              <h3 className="uppercase flex items-center gap-3.5 mobile:text-[21px] tablet:text-2xl laptop:text-2xl font-bold font-inter text-white">
                ...
                <span className="mobile:hidden tablet:flex laptop:flex items-center gap-1 text-sm bg-gray-700 w-[120px] justify-center h-10 border border-gray-500 rounded-full">
                  Creator
                  <img
